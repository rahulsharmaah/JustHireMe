---
page_id: 'entity:state-machine-langgraph-backend'
kind: entity
cssclasses:
  - swarmvault
  - sv-entity
title: 'State Machine: LangGraph Backend'
tags:
  - entity
  - candidate
source_ids:
...
project_ids: []
node_ids:
  - 'entity:state-machine-langgraph-backend'
freshness: fresh
status: candidate
confidence: 0.65
...
---
# State Machine: LangGraph Backend
